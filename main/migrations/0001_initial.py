    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('machine', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='team', to='main.machine')),
                ('operators', models.ManyToManyField(related_name='teams', to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
